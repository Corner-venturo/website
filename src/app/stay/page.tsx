...
export default function StayDetailsPage() {
  ...
  return (
    <div
      className="relative bg-[#F0EEE6] dark:bg-[#1a1a1a] font-sans antialiased text-gray-900 dark:text-white transition-colors duration-300 h-screen flex flex-col overflow-hidden"
    ...
    >
      ...
      <header className="relative z-50 px-6 pt-12 pb-4 flex items-center justify-between">
        ...
        <h1 className="text-lg font-bold text-gray-800 dark:text-gray-100 tracking-tight">住宿詳情</h1>
        <div className="w-10" />
      </header>
      ...
      <main className="relative z-10 flex-1 w-full h-full overflow-y-auto hide-scrollbar pb-32 px-6 pt-2">
        ...
        <div className="glass-card dark:glass-dark rounded-3xl p-6 mb-5 relative overflow-hidden shadow-soft">
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-morandi-blue/10 rounded-full blur-2xl pointer-events-none" />
          <div className="mb-5 relative z-10">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2 leading-tight">大阪世紀酒店</h2>
          ...
          <div className="flex justify-between items-center mb-6 relative z-10 bg-white/40 dark:bg-white/5 rounded-2xl p-4 border border-white/40 dark:border-white/5">
            <div className="text-left w-[40%]">
              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-1 font-medium">入住 CHECK-IN</div>
              <div className="text-lg font-bold text-gray-800 dark:text-white tracking-tight">11月15日</div>
              <div className="text-xs font-medium text-gray-400 mt-0.5">週五 15:00</div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <div className="w-px h-8 bg-gray-300 dark:bg-gray-600 mb-1" />
              <div className="bg-primary/10 text-primary px-2 py-0.5 rounded-md text-[10px] font-bold">3 晚</div>
            </div>
            <div className="text-right w-[40%]">
              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-1 font-medium">退房 CHECK-OUT</div>
              <div className="text-lg font-bold text-gray-800 dark:text-white tracking-tight">11月18日</div>
          ...
          <div className="flex items-start justify-between gap-3 relative z-10">
            <div className="flex items-start gap-2.5">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed font-medium">大阪府大阪市北區大深町 3-1</span>
            </div>
            <button
              className="shrink-0 w-8 h-8 rounded-full bg-white dark:bg-white/10 border border-gray-100 dark:border-gray-700 text-morandi-blue flex items-center justify-center shadow-sm"
              aria-label="查看地圖"
            >
        ...
        <div className="bg-white dark:bg-[#252525] rounded-2xl shadow-sm mb-6 border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
          <div className="p-5 relative z-10">
            <div className="flex justify-between items-start">
              <div>
                <div className="text-[10px] text-gray-400 mb-1 uppercase tracking-wider font-bold">訂房代號 (Booking ID)</div>
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-mono font-bold text-gray-800 dark:text-white tracking-widest">HTL-88293</span>
                  <button
                    className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-primary transition-colors"
                    aria-label="複製訂房代號"
                  >
              ...
              <div className="w-10 h-10 bg-morandi-blue/10 dark:bg-morandi-blue/20 rounded-lg flex items-center justify-center">
          ...
          <button className="w-full p-4 flex justify-between items-center hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                <span className="material-icons-round text-sm">description</span>
              </div>
              <div className="text-left">
                <div className="text-xs font-bold text-gray-700 dark:text-gray-200">入住憑證 (e-Voucher)</div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="glass-card dark:glass-dark p-3.5 rounded-2xl flex items-start gap-3">
            ...
            <div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">房型</div>
          ...
          <div className="glass-card dark:glass-dark p-3.5 rounded-2xl flex items-start gap-3">
            ...
            <div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">入住人數</div>
              <div className="text-sm font-bold text-gray-800 dark:text-gray-200">2 位成人</div>
            </div>
          </div>
          ...
          <div className="glass-card dark:glass-dark p-3.5 rounded-2xl flex items-start gap-3">
            ...
            <div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">特殊需求</div>
          ...
          <div className="glass-card dark:glass-dark p-3.5 rounded-2xl flex items-start gap-3">
            ...
            <div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">付款狀態</div>
              <div className="text-sm font-bold text-green-600 dark:text-green-400">已付款</div>
            </div>
          </div>
        </div>

        <div className="bg-[#FDFCF8] dark:bg-white/5 p-5 rounded-2xl border border-primary/20 mb-8 relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 mb-3 relative z-10">
            ...
            <span className="font-bold text-sm text-gray-700 dark:text-gray-200">入住須知</span>
          </div>
          <ul className="text-xs text-gray-500 dark:text-gray-400 space-y-3 list-none relative z-10">
            ...
            <li className="flex gap-2.5 items-start">
              <div className="bg-gray-100 dark:bg-white/10 px-2 py-1 rounded text-[10px] text-gray-600 dark:text-gray-300 font-mono flex items-center gap-1">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-6 bg-gradient-to-t from-[#F0EEE6] via-[#F0EEE6]/95 to-transparent dark:from-[#1a1a1a] dark:via-[#1a1a1a]/95 pointer-events-none">
        <div className="pointer-events-auto flex gap-3 max-w-md mx-auto w-full">
          <button className="flex-1 py-3.5 rounded-2xl bg-white dark:bg-white/10 text-gray-600 dark:text-gray-200 font-bold text-sm shadow-sm border border-gray-200 dark:border-gray-700 hover:bg-gray-50 transition-all active:scale-95 flex items-center justify-center gap-2">
