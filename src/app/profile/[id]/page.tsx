    ...
    <div className="font-display text-charcoal antialiased bg-bone-white min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-bone-white/80 backdrop-blur-md pt-12 pb-3 px-6">
        <div className="flex justify-between items-center max-w-md mx-auto">
          ...
          <h1 className="text-[14px] font-bold tracking-[0.2em] uppercase text-charcoal">Traveler Story</h1>
          <button
            onClick={handleShare}
            className="material-symbols-outlined text-[24px] font-light text-charcoal/50"
          >
            share
          </button>
        </div>
