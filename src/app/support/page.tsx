  ...
  return (
    <div className="bg-[#F0EEE6] font-sans antialiased text-gray-900 min-h-screen flex flex-col">
      ...
      <header className="relative z-50 px-6 pt-12 pb-4 flex items-center justify-between">
        <Link
          href="/orders"
          className="w-10 h-10 flex items-center justify-center rounded-full bg-white/70 backdrop-blur-xl border border-white/60 shadow-sm text-gray-600 hover:text-[#Cfb9a5] transition-colors"
        >
      ...
      {/* 主要內容 */}
      <main className="relative z-10 flex-1 w-full overflow-y-auto hide-scrollbar pb-10">
        {/* 歡迎訊息 */}
        ...
        <div className="px-6 mb-8">
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-white/60 relative overflow-hidden group">
        ...
        <div className="px-6 space-y-4 mb-8">
          ...
          <button className="w-full bg-white/50 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-4 text-left shadow-lg border border-white/40 hover:bg-white/70 transition-all group active:scale-[0.98]">
          ...
          <button className="w-full bg-white/50 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-4 text-left shadow-lg border border-white/40 hover:bg-white/70 transition-all group active:scale-[0.98]">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 mt-0.5 truncate">support@venturo.com</p>
            </div>
            <span className="material-icons-round text-gray-300 group-hover:text-[#Cfb9a5] transition-colors">chevron_right</span>
          </button>
        ...
        <div className="px-6">
          ...
          <p className="text-center text-xs text-gray-400 mt-6 mb-4">© 2024 Venturo. All rights reserved.</p>
        </div>
      </main>
