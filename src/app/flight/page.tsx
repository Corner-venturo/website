    ...
    <div className="bg-[#F0EEE6] text-gray-900 min-h-screen font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl mx-auto flex flex-col min-h-screen">
        ...
        <main className="flex-1 w-full h-full overflow-y-auto hide-scrollbar pb-32 px-6 pt-2 space-y-5">
          <section className="glass-card rounded-3xl p-6 relative overflow-hidden shadow-soft">
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
          ...
          <section className="bg-[#FDFCF8] p-5 rounded-2xl border border-primary/20 relative overflow-hidden">
